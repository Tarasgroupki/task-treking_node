...
router.get("/roles", SettingsController.roles_get_all);

router.get("/roles/:roleId", SettingsController.roles_get_one_by_id);


router.get("/role/:roleName", SettingsController.roles_get_one_by_name);

router.post("/roles", SettingsController.roles_create_roles);

router.patch("/roles/:roleId", SettingsController.roles_edit_role);

router.delete("/roles/:roleId", SettingsController.roles_delete_role);
