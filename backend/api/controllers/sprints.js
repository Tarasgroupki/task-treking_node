...
exports.sprints_create_sprint = async (req, res) => {
  try {
...
exports.sprints_get_one = async (req, res) => {
...
exports.sprints_edit_sprint = async (req, res) => {
  const id = req.params.sprintId;
  try {
...
exports.sprints_get_points = async (req, res) => {
  const id = req.params.sprintId;
  let dateReason = 0;
  let countDays = 0;
  const marks = [];
...
exports.sprints_delete_sprint = async (req, res) => {
  const id = req.params.sprintId;
  try {
