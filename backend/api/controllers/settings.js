...
exports.permissions_get_all = (req, res, next) => {
    Permission.find()
        .exec()
        .then(docs => {
            console.log(docs);
...
exports.permissions_create_permission = (req, res, next) => {
...
exports.roles_get_one_by_id = (req, res, next) => {
...
exports.roles_get_one_by_name = (req, res, next) => {
...
exports.roles_create_roles = (req, res, next) => {
    const role = new Role({
        _id: new mongoose.Types.ObjectId(),
...
exports.roles_edit_role = (req, res, next) => {
    const id = req.params.roleId;
    const updateOps = {};
...
exports.get_all_roles_has_permission = (req, res, next) => {
...
exports.get_one_roles_has_permission = (req, res, next) => {
    const id = req.params.roleId;
    let permissions = {};
...
exports.roles_create_roles_has_permission = (req, res, next) => {
